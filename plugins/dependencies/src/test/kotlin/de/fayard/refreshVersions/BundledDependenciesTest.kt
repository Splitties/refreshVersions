...
class BundledDependenciesTest {
    ...
    private object Files {
        ...
        val rules = mainResources.resolve("refreshVersions-rules").resolve("dependency-groups-alias-rules.txt")
    ...
    fun `The artifactVersionKeyRules property should contain all rules`() {
        val dirFileNames = mainResources.resolve("refreshVersions-rules")
