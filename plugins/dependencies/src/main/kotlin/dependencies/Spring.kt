...
object Spring : IsNotADependency {
    ...
    object Boot : DependencyGroup("org.springframework.boot", usePlatformConstraints = true) {
        ...
        object Data : IsNotADependency {
            ...
            val cassandraReactive = module("spring-boot-starter-data-cassandra-reactive")

            val couchbase = module("spring-boot-starter-data-couchbase")

            val couchbase_reactive = module("spring-boot-starter-data-couchbase-reactive")

            val elasticsearch = module("spring-boot-starter-data-elasticsearch")
            ...
            val mongodbReactive = module("spring-boot-starter-data-mongodb-reactive")
            ...
            val redis_reactive = module("spring-boot-starter-data-redis-reactive")
        ...
        val oauth2ResourceServer = module("spring-boot-starter-oauth2-resource-server")
    ...
    object Cloud : DependencyGroup("org.springframework.cloud", usePlatformConstraints = true) {
        ...
        val cloudfoundry_discovery = module("spring-cloud-cloudfoundry-discovery")
        ...
        val circuitbreakerReactorResilience4J = module("spring-cloud-starter-circuitbreaker-reactor-resilience4j")

        val config = module("spring-cloud-starter-config")

        val consulConfig = module("spring-cloud-starter-consul-config")

        val consulDiscovery = module("spring-cloud-starter-consul-discovery")

        val contractStubRunner = module("spring-cloud-starter-contract-stub-runner")

        val contractVerifier = module("spring-cloud-starter-contract-verifier")
        ...
        object Netflix : IsNotADependency {
            ...
            val eurekaClient = module("spring-cloud-starter-netflix-eureka-client")

            val eurekaServer = module("spring-cloud-starter-netflix-eureka-server")

            val hystrix = module("spring-cloud-starter-netflix-hystrix")

            val hystrixDashboard = module("spring-cloud-starter-netflix-hystrix-dashboard")

            val ribbon = module("spring-cloud-starter-netflix-ribbon")

            val turbine = module("spring-cloud-starter-netflix-turbine")

            val turbineStream = module("spring-cloud-starter-netflix-turbine-stream")
        ...
        val openServiceBroker = module("spring-cloud-starter-open-service-broker")
        ...
        val zookeeperConfig = module("spring-cloud-starter-zookeeper-config")

        val zookeeperDiscovery = module("spring-cloud-starter-zookeeper-discovery")
        ...
        object Stream : IsNotADependency {
            ...
            val binderKafkaStreams = module("spring-cloud-stream-binder-kafka-streams")
        }
