...
:versions_kt: https://github.com/jmfayard/buildSrcVersions/blob/master/sample-groovy/buildSrc/src/main/kotlin/Versions.kt
:libs_kt: https://github.com/jmfayard/buildSrcVersions/blob/master/sample-groovy/buildSrc/src/main/kotlin/Libs.kt
