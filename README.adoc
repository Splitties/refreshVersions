...
:contributors_badge: https://www.codetriage.com/jmfayard/buildsrcversions/badges/users.svg
...
{badge_version} {contributor_badge} {badge_build} {badge_mit} {badge_issues} {badge_pr}
