...
open class GradleKotlinDslLibsPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        val benManesVersions: DependencyUpdatesTask = project.tasks.maybeCreate("dependencyUpdates", DependencyUpdatesTask::class.java)
        benManesVersions.outputFormatter = "json"
        benManesVersions.checkForGradleUpdate = true



        project.tasks.register("syncLibs", SyncLibs::class) {
